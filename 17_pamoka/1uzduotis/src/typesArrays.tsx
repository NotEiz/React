...
type Person1 = {
   ...
   console.group("Užduotys");
   {
     ...
     {
          const words = ["dede","jurgis","kazkas"];

          const FirstLetters = (arr:string[]) => {
               return arr.map(word => word[0]).join("").toUpperCase()
          }
     ...
     );
     {
          ...
          const MultiplyNums = (arr:number[]) => {
               return arr.reduce( (a, b) => a * b);
          }

          console.log(MultiplyNums(nums))
       /*
           Pvz.:
            * [1, 7, 8] -> 56
            * [98, 74, 5, 0] -> 0
